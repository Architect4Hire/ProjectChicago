...
// Request contract for Task reassignment (TASK-013..014, API-001..007; api-contracts.md).
// TaskId identifies the Task to reassign, AssignedUserId is the new target user, and ConcurrencyToken
...
public sealed record ReassignTaskViewModel
{
